...
gulp.task("copy-jpg",function () {
    gulp.src("./img/*.jpg").pipe(gulp.dest("./dist/public/images/"));
    gulp.src("./img/*.png").pipe(gulp.dest("./dist/public/images/"));
    gulp.src("./img/*.gif").pipe(gulp.dest("./dist/public/images/"));
    gulp.src("./img/*.bmp").pipe(gulp.dest("./dist/public/images/"));
});
...
gulp.task("copy-html",function () {
    gulp.src("./*.html").pipe(gulp.dest("./dist/public/"));
});
